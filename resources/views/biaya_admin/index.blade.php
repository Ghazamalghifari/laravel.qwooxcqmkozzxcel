...
<div class="container">
	<div class="row">
		<div class="col-md-12"> 
			...
			<button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal"><i class="fa fa-plus"> </i> BIAYA ADMIN </button> <br><br>
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">Form Tambah Biaya Admin</h4>
            ...
            <div class="modal-body">
               ...
               {!! Form::open(['url' => route('biaya_admin.store'),'method' => 'post', 'class'=>'form-horizontal']) !!}
